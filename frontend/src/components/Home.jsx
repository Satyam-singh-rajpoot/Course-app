...
const handleLogout = async()=>{
  ...
  try {
    ...
    toast.error(error.response.data.message || "Error in loggin out")
  }
}
        ...
        <header className='flex justify-between items-center p-6 '>
              ...
              >
                Logout
                       ...
                       <>
                       <Link to="/login" className='bg-orange-500 px-4 py-2 rounded-md hover:bg-orange-600 transition-all duration-300'>Login</Link>
                    <Link to="/signup" className='bg-orange-500 px-4 py-2 rounded-md hover:bg-orange-600 transition-all duration-300 ml-2'>Signup</Link>
                       </>
                    )}
                </div>
                </header>
        ...
        <section className="p-8">
          <div className="flex flex-col md:flex-row ">
            {courses.splice(0,4).map((course) => (
              <div key={course._id} className="p-2 w-100">
                <div className="relative flex-shrink-0 w-80 transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <Link to="" className="mt-8 bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-500 duration-300">
                        Enroll Now
                      </Link>
                    </div>
                  </div>
